    ...
    <div className="login-page">
      ...
      <div className="login-brand-area">
        ...
        <p style={{ fontSize: 15, color: '#78716C', lineHeight: 1.6, maxWidth: 440, margin: '0 0 40px' }}>
          One hub for every vibe. Find live music, nightlife, art, tech, comedy, food, and community events — all in one place.
        </p>
        ...
        <div className="login-auth-card">
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 14, color: '#78716C', margin: 0, lineHeight: 1.5 }}>
              Log in to continue your journey with Habesha Hub
            </p>
          </div>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: '#78716C', cursor: 'pointer' }}>
                <input type="checkbox" style={{ accentColor: '#FFB000', width: 16, height: 16 }} />
                Remember me
              </label>
          ...
          <p style={{ textAlign: 'center', fontSize: 14, color: '#78716C', marginTop: 24 }}>
            ...
            <a href="/signup" style={{ color: '#FFB000', fontWeight: 600, textDecoration: 'none' }}>
              Sign up
            </a>
          </p>
